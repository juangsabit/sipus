...
<div id="content">
	<p id="tombol-tambah-container"><a href="home.php?p=transaksi-peminjaman-input" class="tombol">Transaksi Baru</a></p>
	<table id="tabel-tampil">
		...
		<tr>
			...
			<td>
				...
				<div class="tombol-opsi-container"><a onclick="myFunction<?php echo $r_transaksi['idtransaksi']; ?>()" class="tombol">Pengembalian</a></div>
			</td>
		</tr>
		<script>
		function myFunction<?php echo $r_transaksi['idtransaksi']; ?>() {
			var txt;
			var r = confirm("Apakah anda yakin akan mengembalikan?");
			if (r == true) {
				txt = "You pressed OK!";
				window.location = "proses/pengembalian-proses.php?id=<?php echo $r_transaksi['idtransaksi']; ?>";
			} else {
